...
$apps_source = 'https://raw.githubusercontent.com/pukauw/azure-client/master/install-apps.ps1'
$apps_destination = 'install-apps.ps1'

## Download and Install Dev Cert
$dev_source = 'https://raw.githubusercontent.com/pukauw/azure-client/master/dev.cer'
